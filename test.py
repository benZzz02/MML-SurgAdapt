...
def main():
    ...
    if cfg.test_loss == 'SPLC':
        criterion = SPLC()
    if cfg.test_loss == 'GRLoss':
        criterion = GRLoss()
    if cfg.test_loss == 'Hill':
        criterion = Hill()
    if cfg.test_loss == 'ASL':
        criterion = AsymmetricLossOptimized()
    if cfg.test_loss == 'WAN':
        criterion = WAN()
    if cfg.test_loss == 'VLPL_Loss':
        criterion = VLPL_Loss()
    if cfg.test_loss == 'iWAN':
        criterion = iWAN()
    if cfg.test_loss == 'G-AN':
        criterion = G_AN()
    if cfg.test_loss == 'LL':
        criterion = LL()
    if cfg.test_loss == 'Weighted_Hill':
